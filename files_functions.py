...
class FileManager:
    def __init__(self, settings_file_name: str = 'settings.json'):
        ...
        self.__secret_key_path = settings['secret_key']
    ...
    @property
    def get_secret_key_path(self) -> str:
        return self.__secret_key_path
    ...
    def save_asymmetric_private_key(self, private_key) -> None:
        ...
        """
        try:
            with open(self.__secret_key_path, 'wb') as private_out:
    ...
    def read_asymmetric_private_key(self):
        ...
        private_key = None
        try:
            with open(self.__secret_key_path, 'rb') as pem_in:
